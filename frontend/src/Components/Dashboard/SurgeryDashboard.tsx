...
import { Box, Button, Card, CardContent, CardHeader, FormControl, InputAdornment, InputLabel, MenuItem, Select, TextField, Typography } from '@mui/material';
      ...
      >
        ...
        >
          ...
          <CardContent>
            ...
            >
              {/* search input */}
              <Box sx={{ flex: 1, border: "none", position: "relative", width: { xs: "100%" }}}>
                <TextField
                  fullWidth
                  variant="outlined"
